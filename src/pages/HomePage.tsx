  ...
  return (
    <div className="overflow-x-hidden">
      <div className="px-[160px] pt-2 font-inter">
        ...
        {/* Hero section */}
        <div className="flex justify-between items-center h-[90dvh] relative">
          <div>
          ...
          <div>
            <img src={Dashboard} className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 rounded-xl"/>
          </div>
        </div>
        {/* Mission section */}
        <div
